![alt pokemon meduza](http://pokelife.pl/pokemony/593.png "Jellicent")
# Meduza
...
5. - [x] Branch management
   ...
   6. - [x] Tagging
6. - [x] Interactive staging
   1. - [x] Interactive mode
   2. - [x] Patch mode
   3. - [x] Split hunk
   4. - [x] Edit hunk
7. - [x] Wybór udostępnionych zmian
   1. - [x] Cherry-picking commits
   2. - [x] Cherry-picking - rozwiązywanie problemów
   3. - [x] Diff patches
   4. - [x] Akceptacja diff patches (git apply)
   5. - [x] Rebase
